...
def data_generator(problem, samples=None) -> Tuple[LabeledDataSetToLearn, Any]:
    """
    ...
    if problem == 'circle':
        ...
        return split_dataset(data, 200), settings
    #
...
def _circle(samples: int) -> Tuple[LabeledDataSet, Tuple[List[float], List[float]]]:
